...
class ProfileRepositoryImpl extends ProfileRepository {
  ...
  @override
  Future<Either<PrimaryServerException, Profile>> updateProfileInfo(String token, dynamic updateProfile) async{
    if (await networkInfo.isConnected) {
      try{
        final profile = await profileRemoteDataSource.updateProfileInfo(token, updateProfile);
