...
class HotelsOnGoogleMap extends StatefulWidget{
  @override
  _HotelsOnGoogleMapState createState() => _HotelsOnGoogleMapState();
}

class _HotelsOnGoogleMapState extends State<HotelsOnGoogleMap> {
